...
<head>
    ...
    <title>Tambah Data Pensiunan</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet">
</head>
<body>
    <div class="container mt-5 mb-5">
        <h2>Tambah Data Pensiunan Baru</h2>
        <hr>
        ...
        <form action="{{ route('pensiunans.store') }}" method="POST">
            @csrf
            <div class="card">
                <div class="card-header">Detail Pensiunan</div>
                <div class="card-body">
                    <div class="mb-3">
            ...
            <div class="mt-4">
                ...
                <a href="{{ route('pensiunans.index') }}" class="btn btn-secondary">Batal</a>
            </div>
        </form>
    </div>
</body>
